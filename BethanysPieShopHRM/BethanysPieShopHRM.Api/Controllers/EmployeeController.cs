...
namespace BethanysPieShopHRM.Api.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public IActionResult CreateEmployee([FromBody] Employee employee)
        {
            ...
            employee.ImageName = SaveImageToFolder(employee.ImageName, employee.ImageContent);
        ...
        private string SaveImageToFolder(string imageName, byte[] imageContent)
        {
            if(!string.IsNullOrEmpty(imageName))
            {
                ...
                fileStream.Close();
                return $"https://{currentUrl}/uploads/{imageName}";
            }
            return null;
        }
