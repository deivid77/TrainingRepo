...
namespace Core.Common.Extensions
{
    public static class CoreExtensions
    {
        ...
        private static bool IsNavigable(this PropertyInfo property)
        {
            bool navigable = true;
        ...
        private static bool IsNavigable(this ObjectBase obj, string propertyName)
        {
            PropertyInfo propertyInfo = obj.GetType().GetProperty(propertyName);
            return propertyInfo.IsNavigable();
        }

        //private static bool IsNavigable<T>(this ObjectBase obj, Expression<Func<T>> propertyExpression)
        //{
